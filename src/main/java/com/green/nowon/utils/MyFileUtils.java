...
public class MyFileUtils {
	...
	public static Map<String,String> fileUpload(MultipartFile goodsimg, String location) {
		...
		try {
			folder=cpr.getFile();
			orgName=goodsimg.getOriginalFilename();
			...
			//원본.이름_23847923.jpg
			goodsimg.transferTo(new File(folder, fileName));
